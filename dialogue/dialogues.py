...
Duncan_Dialogue.add('0000', (characters.player.name + "!"), action=lambda: npc_actions.handshake("Duncan"))
Duncan_Dialogue.add('1000', (characters.player.name + "!"), action=lambda: npc_actions.handshake("Duncan"))
...
Duncan_Dialogue.add('000000000000', "I've been meaning to get around to shredding some old documents that are... taking up unnecessary space.")
Duncan_Dialogue.add('100000000000', "I've been meaning to get around to shredding some old documents that are... taking up unnecessary space.")
Duncan_Dialogue.add('0000000000000', "There should be a box in the Mail Room somewhere, find it and bring it back to me. I'll be in my Study.", action=lambda: characters.Duncan.move_rooms(rooms.study), pause=True)
Duncan_Dialogue.add('1000000000000', "There should be a box in the Mail Room somewhere, find it and bring it back to me. I'll be in my Study.", action=lambda: characters.Duncan.move_rooms(rooms.study), pause=True)
Duncan_Dialogue.add('00000000000000', "Need help finding the box of mail?", checkpoint=True)
Duncan_Dialogue.add('10000000000000', "Need help finding the box of mail?", checkpoint=True)
Duncan_Dialogue.add('000000000000000', "You found it!")
Duncan_Dialogue.add('100000000000000', "You found it!")
